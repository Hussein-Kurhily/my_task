...
class EditTaskCustomBottomSheet extends StatelessWidget {
  const EditTaskCustomBottomSheet({super.key, required this.id});
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  CustomTextFormField(
                    autofocus: true,
                    controller: TaskCubit.get(context).titleTextEditingController,
                    hintText: 'Task title',
                    validator: (p0) {
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        onPressed: () {
                          TaskCubit.get(context).getTaskInfoToEdit(id:id);
                          if (TaskCubit.get(context).validChick()) {
                            // update task table
                            TaskCubit.get(context).updateTask(id: id );
